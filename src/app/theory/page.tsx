    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="min-h-screen bg-white">
        <Container className="py-5">
          ...
          <p className="font-mono font-bold text-amber-400 text-xl"> Your World-view about AI</p>
          <p className="font-mono text-sm">
          ...
          <p className="font-mono font-bold text-amber-400 text-2xl"> Maturity level </p>
          <p className="font-mono text-sm">
          ...
          <p className="font-mono font-bold text-amber-400 text-2xl"> Type of Instrument </p>
          <p className="font-mono text-sm">
